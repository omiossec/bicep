...
namespace Bicep.Core.TypeSystem
{
    ...
    {
        public NamedObjectType(string name, IEnumerable<TypeProperty> properties, TypeReference? additionalProperties, TypePropertyFlags additionalPropertiesFlags = TypePropertyFlags.None)
            : base(name)
        {
        ...
        public override TypeReference? AdditionalProperties { get; }
