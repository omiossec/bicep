...
param secureInt int {
  secure: true
//@[2:8) Error The property 'secure' is not allowed on objects of type ParameterModifier<int>. |secure|
  minLength: 3
//@[2:11) Error The property 'minLength' is not allowed on objects of type ParameterModifier<int>. |minLength|
  maxLength: 123
//@[2:11) Error The property 'maxLength' is not allowed on objects of type ParameterModifier<int>. |maxLength|
}
...
//@[36:83) Error The expression is involved in a cycle. |{\n  allowed: [\n    paramModifierSelfCycle\n  ]\n}|
  allowed: [
//@[2:44) Error The expression is involved in a cycle. |allowed: [\n    paramModifierSelfCycle\n  ]\n|
//@[11:43) Error The expression is involved in a cycle. |[\n    paramModifierSelfCycle\n  ]|
    paramModifierSelfCycle
//@[4:26) Error The expression is involved in a cycle. |paramModifierSelfCycle|
//@[4:27) Error The expression is involved in a cycle. |paramModifierSelfCycle\n|
